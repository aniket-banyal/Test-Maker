...
urlpatterns = [
    ...
    path('quiz/<int:pk>/delete/',
         quiz_views.QuizDeleteView.as_view(), name='quiz-delete'),
    path('quiz/new/', quiz_views.newQuiz, name='new-quiz'),
    path('quiz/<int:pk>/duplicate/',
         quiz_views.quizDuplicate, name='quiz-duplicate'),
    path('quiz/<int:pk>/result/',
         quiz_views.quizResult, name='quiz-result'),
    path('take-quiz/<int:pk>/', taker_views.takeQuiz,
         name='take-quiz'),
    path('take-quiz/<int:pk>/<int:user_id>/',
         taker_views.submitQuiz, name='submit-quiz'),
    path('take-quiz/<int:pk>/<int:user_id>/result',
